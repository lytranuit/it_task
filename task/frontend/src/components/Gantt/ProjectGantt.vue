<template>
  <EjsGantt :key="key" ref='gantt' :dataSource="taskList" :treeColumnIndex='1' id="GanttContainer"
    ...
    :project-end-date="projectEndDate" :allowResizing="true" :allowFiltering="true" :filterSettings="{
      type: 'Excel'
    }">
    <EjsGanttColumns>
    ...
    <template v-slot:user_createdTemplate="{ data }">
      <div v-if="data.taskData.user_created" class="d-flex">
        <Avatar :image="data.taskData.user_created.image_url" :title="data.taskData.user_created.fullName" size="small"
