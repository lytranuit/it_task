        ...
        <div class="col-12">
            <section class="card card-fluid">
                ...
                <div class="card-body" style="overflow: auto; position: relative">
                    ...
                    <DataTable showGridlines :value="datatable" :lazy="true" ref="dt" :paginator="true" scrollHeight="70vh"
                        class="p-datatable-customers" :rowsPerPageOptions="[10, 50, 100]" :rows="rows"
                        ...
                        <template #header>
                            <div class="d-flex">
                                ...
                                <div class="ml-auto">
                                    <Button label="In Excel" icon="pi pi-print" class="p-button-primary p-button-sm mr-2"
                                        @click="print"></Button>
                                </div>
                            </div>
                        </template>
                        ...
                        <Column v-for="col of selectedColumns" :field="col.data" :header="col.label" :key="col.data">
                            ...
                            <template #filter="{ filterModel, filterCallback }" v-if="col.filter == true">
                                <template v-if="col.data == 'datetime'">
                                    <Calendar v-model="datetime" dateFormat="mm/dd/yy" placeholder="từ ngày - đến ngày"
                                        mask="99/99/9999" selectionMode="range" :hideOnRangeSelection="true" />
                                </template>
